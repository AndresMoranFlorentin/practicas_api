...
$controladorMovies= new controladorMovies();
...
switch ($params[0]) {
    case 'home':
        ...
        break;
    case 'Ir_seccion_limpieza':
        $controlador->ir_a_limpieza();
        break;
    case 'Ir_seccion_Peliculas':
        $controladorMovies->mostrarMovies();
        break;
    case 'Ir_seccion_aeropuertos':
