...
class vistaapi
{
    ...
    function mostrarPagina($habilitar)
    {
       
        if($habilitar=="HOME"){

         $this->smarty->assign('BASE_URL', BASE_URL);
         $this->smarty->display('template/tabla.tpl');

        }

        elseif($habilitar=="Limpieza"){

            $this->smarty->assign('BASE_URL', BASE_URL);
            $this->smarty->display('template/seccionLimpieza.tpl');
        }
        else{
            $this->smarty->assign('BASE_URL', BASE_URL);
            $this->smarty->display('template/seccionPeliculas.tpl');
